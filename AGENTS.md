...
|----------|------|-------------|
| README | README.md | Project landing page with installation and getting started guide |
| Deployment | DEPLOYMENT.md | Deployment instructions and server configuration |
| Security | SECURITY.md | Security policy and reporting guidelines |
| Architecture | .ai-factory/ARCHITECTURE.md | Architecture decisions and guidelines (generated by /aif-architecture) |
