...
- [ ] Task 1: Create templates/packages/cardboard/README.md with high-level overview and quick start guide.
...
- [ ] Task 2: Create docs/marko/src/content/docs/packages/cardboard.md for the Starlight documentation site.
...
- [ ] Task 3: Document Core Architecture (BaseComponent, configuration merging, lifecycle methods).
...
- [ ] Task 4: Document ArticleEditor component (comprehensive configuration options, usage examples, autosave/media features).
  ...
  - Files: templates/packages/cardboard/README.md, docs/marko/src/content/docs/packages/cardboard.md
- [ ] Task 5: Document Notification system (NotificationManager usage and NotificationAdapter for decoupled services).
  ...
  - Files: templates/packages/cardboard/README.md, docs/marko/src/content/docs/packages/cardboard.md
- [ ] Task 6: Document Utility helpers (DOM manipulation, Event management, API wrapper).
...
- [ ] Task 7: Run /aif-docs to synchronize and update main project documentation.
